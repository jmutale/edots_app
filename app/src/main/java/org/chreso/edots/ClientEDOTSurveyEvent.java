...
public class ClientEDOTSurveyEvent {
    private String edot_survey_uuid;
    private String edot_survey_date;
    ...
    public String getEdot_survey_date() {
        return edot_survey_date;
    }

    public void setEdot_survey_date(Date edot_survey_date) {
        this.edot_survey_date = Utils.getFormattedDate(edot_survey_date);
    }
